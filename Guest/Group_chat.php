...
$sql = "INSERT INTO guestchat (uname, msg, dt)
        VALUES ('$un', '$m', '$ts')";
...
<div id="container">
    <main>
        <header>
            ...
            <button style="padding:20px;text-align:right;" onclick="location.href=('index.php')">Clear</button>
        </header>
